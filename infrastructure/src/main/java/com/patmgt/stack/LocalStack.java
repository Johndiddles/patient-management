...
public class LocalStack extends Stack {
    private final String stackId = "PatientManagement";
    public final Vpc vpc;
    public final Cluster ecsCluster;
...
//                "BILLING_SERVICE_ADDRESS", "host.docker.internal",
    ...
    private Vpc createVpc() {
        String vpcId = String.format("%sVPC", stackId);
        return Vpc
                .Builder
                .create(this, vpcId)
                .vpcName(vpcId)
    ...
    private Cluster createEcsCluster() {
        return Cluster
                .Builder
                .create(this, String.format("%sCluster", stackId))
                .vpc(vpc)
    ...
    private FargateService createFargateService(
        ...
        envVars.put("SPRING_KAFKA_BOOTSTRAP_SERVERS", "localhost.localstack.cloud:5410, localhost.localstack.cloud:5411, localhost.localstack.cloud:5412");
